        ...
        className="flex flex-col w-full gap-y-4 mt-6">
            <label className="w-full">  
                ...
                <label className="w-full relative">
                    <p className="text-[0.875rem] text-slate-50 mb-1 leading-[1.375rem]">Password<sup className="text-pink-600">*</sup></p>
                    <input
                    required
            ...
            <button className="bg-purple-700 rounded-[8px] font-medium text-white px-[12px] py-[8px] mt-6">
                Sign In
            </button>
